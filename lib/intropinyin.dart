...
class PinyinTones extends StatelessWidget {
  const PinyinTones({Key? key}) : super (key: key);
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        appBar: AppBar(
          ...
          title: const Text('P I N Y I N  &  T O N E S'),
          titleSpacing: 0.0,
          leading: IconButton(
...
class VideoGrid extends StatelessWidget {
  final List<VideoInfo> videos = [
    VideoInfo(
      videoUrl: 'https://www.youtube.com/watch?v=8u7FBqIgSlw',
      name: 'Chinese Alphabet',
    ),
    VideoInfo(
      videoUrl: 'https://youtu.be/SqI3BCMIhJc',
      name: 'Pronunication Tones',
    ),
